                            ...
                            children: <Widget>[
                              Flexible(
                                ...
                                child: Column(
                                    ...
                                    children: <Widget>[
                                      Text(
                                        DateFormat('MMMM d, y KK:mm a').format(
                                            DateFormat('yyyy-MM-dd hh:mm:ss')
                                                .parse(exams[index].createdat)),
                                        style: TextStyle(
                                      ...
                                      Text('মোট প্রশ্নঃ ' +
                                          exams[index].totalqstn.toString() +
                                          'টি, সময়ঃ ' +
                                          exams[index].duration.toString() +
                                          ' মিনিট'),
                                      Text('উত্তর প্রদানঃ ' +
                                          (exams[index].rightanswer +
                                                  exams[index].wronganswer)
                                              .toString() +
                                          'টি, সঠিকঃ ' +
                                          exams[index].rightanswer.toString() +
                                          'টি, ভুলঃ ' +
                                          exams[index].wronganswer.toString() +
                                          'টি'),
                                      Text(
                                        'প্রাপ্ত নম্বরঃ ' +
                                            (exams[index].rightanswer -
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    CircularPercentIndicator(
                                      ...
                                      percent: ((exams[index].rightanswer -
                                                      (exams[index]
                                                              .wronganswer *
                                                          0.5)) /
                                                  exams[index].totalqstn >=
                                              0)
                                          ? (exams[index].rightanswer -
                                                  (exams[index].wronganswer *
                                                      0.5)) /
