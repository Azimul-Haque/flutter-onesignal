            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 5,),
                  Text("Written by: A. H. M. Azimul Haque", style: TextStyle(fontSize: 14,),),
                  Divider(color: Colors.grey[850], height: 10,),
                  Text(data["body"] + data["body"] +  _longPostBN, style: TextStyle(color: Colors.grey[850], fontSize: 16), textAlign: TextAlign.justify,),
                  SizedBox(height: 5,),
                  Text("_________"),
                ],
              )
